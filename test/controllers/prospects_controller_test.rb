...
class ProspectsControllerTest < ActionController::TestCase
  ...
  test "should create prospect" do
    assert_difference('Prospect.count') do
      post :create, prospect: { email: @prospect.email, message: @prospect.message, name: @prospect.name, phone: @prospect.phone }
    end
  ...
  test "should update prospect" do
    patch :update, id: @prospect, prospect: { email: @prospect.email, message: @prospect.message, name: @prospect.name, phone: @prospect.phone }
    assert_redirected_to prospect_path(assigns(:prospect))
  end
